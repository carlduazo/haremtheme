        ...
        <div class="container">
            <div class="section__header">
                ...
                <h1 class="section__title">
                    <?= __('De harem Kronieken','harem'); ?>
                </h1>
                <div class="section__text rich-text">
                    <?= __('Verhalen gebrouwen op de straathoek, één kopje tegelijk. Ontdek de wereld van chai, cultuur en gemeenschap terwijl we de verhalen achter de thee stalletjes verkennen, de mensen die ze runnen, en de verhalen die ze te vertellen hebben. Sluit je aan voor een slok inspiratie, traditie en vernieuwing','harem'); ?>
                </div>
            </div>
            <?php
            ...
            if ($categories) {
                ...
                <label for="all" data-filter="*" id="all_data">
                    ...
                    <span  class="button button--outline-primary" ><?= __('Alle', 'epicode'); ?></span>
                    </label>
                <?php
